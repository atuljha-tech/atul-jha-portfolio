...
import { Github, Linkedin, Mail, Twitter, Code2, Cpu, Database, Rocket, Sparkles, ArrowRight } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        {/* Sleek dark angled cutout background shape inspired by reference image */}
        <div 
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        >
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-[#0E0B19] border border-amber-500/30 shadow-lg shadow-amber-500/10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Right Column — Glowing 3D Cycloid Ring Portal (Matching Reference Image) */}
          <motion.div
